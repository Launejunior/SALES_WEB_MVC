    ...
    public class SeedingService
    {
        ...
        public void Seed()
        {
            if (_context.Departamento.Any() ||
                _context.SellerVendedores.Any() ||
                _context.SalesRecorde.Any()) 
            {
                return;
            }

            Departamento d1 = new Departamento("Computador");
            Departamento d2 = new Departamento("NotBook");
            Departamento d3 = new Departamento("Telas");


            SellerVendedor s1 = new SellerVendedor("Rodrigo Viana", "rodrigoviana@gmail.com", new DateTime(1979, 11, 08), 8500, d1);
            SellerVendedor s2 = new SellerVendedor("Kevin Lima ", "kevinlima@gmail.com", new DateTime(1996, 08, 28), 6500, d2);
            SellerVendedor s3 = new SellerVendedor("Jose Laune", "jlaune@gmail.com", new DateTime(1976, 08, 13), 10789, d3);
            SellerVendedor s4 = new SellerVendedor("Gabriel Dev ", "gabrieldev@gmail.com", new DateTime(1997, 10, 28), 8500, d1);

            SalesRecorde r1 = new SalesRecorde(new DateTime(2024, 01, 01), 123, SalesStatus.Pending, s1);
            SalesRecorde r2 = new SalesRecorde(new DateTime(2024, 01, 02), 234, SalesStatus.Billed, s2);
            SalesRecorde r3 = new SalesRecorde(new DateTime(2024, 01, 03), 345, SalesStatus.Canceled, s3);
            SalesRecorde r4 = new SalesRecorde(new DateTime(2024, 01, 04), 567, SalesStatus.Pending, s1);
            SalesRecorde r5 = new SalesRecorde(new DateTime(2024, 01, 05), 789, SalesStatus.Billed, s4);
            /*
            ...
            */
            ...
            _context.SellerVendedores.AddRange(s1, s2, s3, s4);

            _context.SalesRecorde.AddRange(r1, r2, r3, r4, r5);
            /*
            r7, r8, r9, r10,
